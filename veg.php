    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/items-router.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Veg</h4>
              </div>
              <div>
				<table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM items WHERE category='veg'");
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<input value="'.$row["price"].'" id="'.$row["id"].'_price" name="'.$row['id'].'_price" type="number" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';                   
					echo '<td>';
					if($row['deleted'] == 0){
						$text1 = 'selected';
						$text2 = '';
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-veg.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
  ...
  <footer class="page-footer">
    ...
    $("#formValidate1").validate({
		...
		name: {
				...
				minlength: "The field should not be empty."
			},
		 price: {
