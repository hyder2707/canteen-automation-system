    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
            ...
            <div class="row">
              ...
              <div>
				<table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM items WHERE category='beverages'");
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-beverage.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
