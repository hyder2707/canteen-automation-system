            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li  ><a href="#" style="color: black !important; font-size: 25px;">&#8377;<?php echo $balance;?></i></a>
                        </li>
                    </ul>					 
                </div>
            </nav>
            ...
            <div class="row">
              ...
              <div>
                  <table id="data-table-customer" class="responsive-table display" cellspacing="0">
                    ...
                    <tbody>
				<?php
				$result = mysqli_query($con, "SELECT * FROM items where not deleted ORDER BY price ASC;");
				while($row = mysqli_fetch_array($result))
				{
					echo '<tr><td>'.$row["name"].'</td><td>'.$row["category"].'</td><td>'.$row["price"].'</td>';                        
